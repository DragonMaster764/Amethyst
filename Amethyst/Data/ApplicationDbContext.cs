    ...
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Profile>(entity =>
            {
                ...
                {
                    t.HasCheckConstraint("CK_School_Year",
                        "academic_year IN ('Freshman', 'Sophomore', 'Junior', 'Senior', 'Graduate')");
                    t.HasCheckConstraint("CK_User_Notification",
                        "notification_preferences IN ('instant', 'daily_digest', 'urgent-only', 'none')");
                });
                ...
                // --- FIXED RELATIONSHIP (prevents EF from generating shadow UserId) ---
            ...
            modelBuilder.Entity<Course>(entity =>
            {
                ...
                entity.ToTable(t => t.HasCheckConstraint("CK_Course_Term",
                    "term IN ('Spring', 'Summer', 'Fall', 'Winter')"));

                entity.ToTable(t => t.HasCheckConstraint("CK_Course_Academic_Year",
                    "academic_year BETWEEN 1900 AND 3000"));
            ...
            modelBuilder.Entity<Assignment>(entity =>
            {
                ...
                entity.HasCheckConstraint("CK_Assignment_Status",
                    "status IN ('In Progress', 'Not Started', 'Completed')");

                entity.HasCheckConstraint("CK_Assignment_Priority",
                    "priority IN ('Low', 'Medium', 'High')");

                entity.HasCheckConstraint("CK_Est_Min",
                    "estimated_minutes >= 0 AND estimated_minutes <= 10000");
